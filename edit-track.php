...
if(!empty($_POST["data"])){
    ...
    $sql = "UPDATE information SET 
                       ...
                       musikArtist = :musikArtist,
                       musikAlbum = :musikAlbum,
                       musikGenre = :musikGenre,
                       musikOrigin = :musikOrigin,
                       musikRelease = :musikRelease,
                       musikTime = :musikTime,
                       musikBandInstrument = :musikBandInstrument,
                       musikAlbumTracklist = :musikAlbumTracklist,
                       musikBuy = :musikBuy,
                       musikPrice = :musikPrice,
                       musikImg = :musikImg
                       WHERE musikId = :musikId";


    $bind = [
        ":musikId" => $_GET["id"],
        ":musikTitel" => $data["musikTitel"],
    ...
    header('Location: edit-track.php?type=rediger&id='.$_GET["id"]);

}
$bind = [':musikId' => $_GET['id']];
$info = $db->sql("SELECT * FROM information WHERE musikId = :musikId", $bind);
$info = $info[0];
?>
<!DOCTYPE html>
<html lang="da">
...
<section class="main container">
    ...
    <form method="post" action="edit-track.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
        <div class="row">
            <div class="col-12 col-md-6 mb-2">
                <div class=" mb-3 text-white">
                    <label for="musikTitel" class="form-label fs-5">Title</label>
                    <input class="form-control fs-5" type="text" name="data[musikTitel]" id="musikTitel" placeholder="Title" value="<?php echo $info->musikTitel; ?>" required>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 mb-2">
                <div class="has-validation mb-3 text-white">
                    ...
                    <input class="form-control fs-5" type="text" name="data[musikArtist]" id="musikArtist" placeholder="Artist" value="<?php echo $info->musikArtist; ?>" required>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 mb-2">
                <div class="mb-3 text-white">
                    ...
                    <input class="form-control fs-5" type="text" name="data[musikAlbum]" id="musikAlbum" placeholder="Album" value="<?php echo $info->musikAlbum; ?>">
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 mb-4">
                <div class="mb-3 text-white">
                    ...
                    <input class="form-control fs-5" type="text" name="data[musikGenre]" id="musikGenre" placeholder="Genre / subgenre" value="<?php echo $info->musikGenre; ?>">
                </div>
            </div>
            ...
            <div class="col-12 col-md-4 mb-2">
                <div class="mb-3 text-white">
                    ...
                    <input class="form-control fs-5" type="text" name="data[musikOrigin]" id="musikOrigin" placeholder="Origin" value="<?php echo $info->musikOrigin; ?>">
                </div>
            </div>
            ...
            <div class="col-4 mb-2">
                <div class="has-validation mb-3 text-white">
                    ...
                    <input class="form-control fs-5" type="date" name="data[musikRelease]" id="musikRelease" placeholder="" value="<?php echo $info->musikRelease; ?>" required>
                </div>
            </div>
            ...
            <div class="col-4 mb-4">
                <div class="has-validation mb-3 text-white">
                    ...
                    <input class="form-control fs-5" type="time" name="data[musikTime]" id="musikTime" step="1" placeholder="00:00:00" value="<?php echo $info->musikTime; ?>" min="00:00:00" required>
                </div>
            </div>
            ...
            <div class="col-12 mb-2">
                <div class="mb-3 text-white">
                    ...
                    <textarea class="form-control fs-5" name="data[musikBandInstrument]" id="musikBandInstrument" placeholder="" style="height:200px;" ><?php echo $info->musikBandInstrument; ?></textarea>
                </div>
            </div>
            ...
            <div class="col-12 mb-4">
                <div class="mb-3 text-white">
                    ...
                    <textarea class="form-control fs-5" name="data[musikAlbumTracklist]" id="musikAlbumTracklist" placeholder="" style="height:200px;"><?php echo $info->musikAlbumTracklist; ?></textarea>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 mb-2">
                <div class="mb-3 text-white">
                    ...
                    <input class="form-control fs-5" type="text" name="data[musikBuy]" id="musikBuy" placeholder="Amazon product link" value="<?php echo $info->musikBuy; ?>">
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mb-2">
                <div class="mb-3 text-white">
                    ...
                    <input class="form-control fs-5" type="number" step=".01" name="data[musikPrice]" id="musikPrice" placeholder="9.99" value="<?php echo $info->musikPrice; ?>">
                </div>
            </div>
